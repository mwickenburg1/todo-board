...
- IMPORTANT: If a thread contains MULTIPLE DISTINCT requests or topics (e.g. "can you fix X" + "also, unrelated, can you delete Y"), emit a SEPARATE track/watch action for EACH one. Do NOT combine unrelated requests into a single action. Each gets its own taskText and deadline.
